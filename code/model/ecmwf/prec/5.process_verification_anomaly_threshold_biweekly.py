...
#---------------------------------------------------------------
trmm_filename_1 = 'TRMM_' + calendar.month_abbr[target_month] + '_threshold' + str(threshold) + '_Climatology_BiWeekly_' + method + '.nc'
...
if process_cora == True:
   ...
   for i_step in range(0,ec_anomaly.shape[0]):
       ...
       #Plot CORA
       title_str = method + ' in 2-week (Anomaly): CORA' + '\n' + calendar.month_abbr[target_month] + ' (LT' + str(i_step+1) + ')'
       name_str = plot_dir + 'ECMWF_' + calendar.month_abbr[target_month] + '_LT' + str(i_step+1) + '_threshold' + str(threshold) + '_CORA_BiWeekly_' + method + '.png'
       ...
       if method == 'NDD':
           ...
           cora[trmm_climo < 2] = 99 # apply TRMM climatology dry mask, with dummy value of 99

       title_str = method + ' in 2-week (Anomaly): CORA' + '\n' + calendar.month_abbr[target_month] + ' (LT' + str(i_step+1) + ') - white areas denote dry climatological mask'
       name_str = plot_dir + 'ECMWF_' + calendar.month_abbr[target_month] + '_LT' + str(i_step+1) + '_threshold' + str(threshold) + '_CORA_BiWeekly_' + method + '_drymask.png'
       s2s_utility_prec.plot_verification(cora,ec_lat,ec_lon,lat_down,lat_up,lon_left,lon_right,grid_lat,grid_lon,title_str,name_str,'CORA')
...
if process_msss == True:
   ...
   for i_step in range(0,ec_anomaly.shape[0]):
       ...
       #Plot MSSS
       title_str = method + ' in 2-week (Anomaly): MSSS' + '\n' + calendar.month_abbr[target_month] + ' (LT' + str(i_step+1) + ')'
       name_str = plot_dir + 'ECMWF_' + calendar.month_abbr[target_month] + '_LT' + str(i_step+1) + '_threshold' + str(threshold) + '_MSSS_BiWeekly_' + method + '.png'
       ...
       if method == 'NDD':
           ...
           msss[trmm_climo < 2] = 99 # apply TRMM climatology dry mask, with dummy value of 99

       title_str = method + ' in 2-week (Anomaly): MSSS' + '\n' + calendar.month_abbr[target_month] + ' (LT' + str(i_step+1) + ') - white areas denote dry climatological mask'
       name_str = plot_dir + 'ECMWF_' + calendar.month_abbr[target_month] + '_LT' + str(i_step+1) + '_threshold' + str(threshold) + '_MSSS_BiWeekly_' + method + '_drymask.png'
       s2s_utility_prec.plot_verification(msss,ec_lat,ec_lon,lat_down,lat_up,lon_left,lon_right,grid_lat,grid_lon,title_str,name_str,'MSSS')
